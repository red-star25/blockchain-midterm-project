...
const CryptoZombies = () => {
      ...
      if (window.ethereum) {
        ...
        try {
          ...
          const cryptoZombiesContract = new web3Instance.eth.Contract(
            cryptoZombiesABI,
            '0x3F909631321d5916356216f5Fa3015e3B412F814' // Updated contract address
          );
  ...
  const createRandomZombie = async () => {
    ...
    try {
      ...
      const gas = Math.floor(gasEstimate * 1.2); // Add 20% buffer
...
const updateZombieDNA = async (zombieId, zombieLevel) => {
  ...
  try {
    ...
    const transactionHash = await window.ethereum.request({
      ...
      params: [{
        from: userAccount,
        to: '0x3F909631321d5916356216f5Fa3015e3B412F814',  
